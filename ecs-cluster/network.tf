...
resource "aws_internet_gateway" "default" {
  ...
  tags = {
    Name = "${var.namespace}_InternetGateway"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name     = "${var.namespace}_PublicSubnet_${count.index}"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name     = "${var.namespace}_PublicRouteTable"
  }
}
...
resource "aws_nat_gateway" "nat_gateway" {
  ...
  tags = {
    Name     = "${var.namespace}_NATGateway_${count.index}"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name     = "${var.namespace}_PrivateSubnet_${count.index}"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name     = "${var.namespace}_PrivateRouteTable_${count.index}"
  }
}
